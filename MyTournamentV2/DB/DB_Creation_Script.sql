...
CREATE TABLE IF NOT EXISTS `mytournament`.`Tournaments` (
  ...
  PRIMARY KEY (`idTournaments`, `creatorUser`),
  ...
  INDEX `fk_Tournaments_Users1_idx` (`creatorUser` ASC),
...
-- -----------------------------------------------------
-- Data for table `mytournament`.`UserRoles`
-- -----------------------------------------------------
START TRANSACTION;
USE `mytournament`;
INSERT INTO `mytournament`.`UserRoles` (`idUserRoles`, `name`) VALUES (1, 'admin');
INSERT INTO `mytournament`.`UserRoles` (`idUserRoles`, `name`) VALUES (2, 'player');

COMMIT;


-- -----------------------------------------------------
-- Data for table `mytournament`.`Platforms`
-- -----------------------------------------------------
START TRANSACTION;
USE `mytournament`;
INSERT INTO `mytournament`.`Platforms` (`idPlatforms`, `name`, `active`) VALUES (1, 'Steam', 1);
INSERT INTO `mytournament`.`Platforms` (`idPlatforms`, `name`, `active`) VALUES (2, 'Blizzard', 1);
INSERT INTO `mytournament`.`Platforms` (`idPlatforms`, `name`, `active`) VALUES (3, 'EA Sports', 1);

COMMIT;


-- -----------------------------------------------------
-- Data for table `mytournament`.`Games`
-- -----------------------------------------------------
START TRANSACTION;
USE `mytournament`;
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (1, 'Counter Strike Global Offensive', NULL, 1, 1);
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (2, 'Counter Strike Source', NULL, 1, 1);
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (3, 'Team Fortress 2', NULL, 1, 1);
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (4, 'Ark', NULL, 1, 1);
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (5, 'Diablo 3', NULL, 1, 2);
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (6, 'Overwatch', NULL, 1, 2);
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (7, 'Starcraft 2', NULL, 1, 2);
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (8, 'Wordl of Warcraft', NULL, 1, 2);
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (9, 'Fifa 17', NULL, 1, 3);
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (10, 'Madden 17', NULL, 1, 3);
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (11, 'UFC 2', NULL, 1, 3);
INSERT INTO `mytournament`.`Games` (`idGames`, `name`, `idWebRef`, `active`, `idPlatforms`) VALUES (12, 'NHL 17', NULL, 1, 3);

COMMIT;


-- -----------------------------------------------------
-- Data for table `mytournament`.`TypeOfTournaments`
-- -----------------------------------------------------
START TRANSACTION;
USE `mytournament`;
INSERT INTO `mytournament`.`TypeOfTournaments` (`idTypeOfTournaments`, `name`, `active`) VALUES (1, 'Single players', 1);
INSERT INTO `mytournament`.`TypeOfTournaments` (`idTypeOfTournaments`, `name`, `active`) VALUES (2, 'Clans', 1);

COMMIT;


-- -----------------------------------------------------
-- Data for table `mytournament`.`FormatOfTournaments`
-- -----------------------------------------------------
START TRANSACTION;
USE `mytournament`;
INSERT INTO `mytournament`.`FormatOfTournaments` (`idFormatTournaments`, `name`, `active`) VALUES (1, '1 vs 1', 1);
INSERT INTO `mytournament`.`FormatOfTournaments` (`idFormatTournaments`, `name`, `active`) VALUES (2, '2 vs 2', 1);
INSERT INTO `mytournament`.`FormatOfTournaments` (`idFormatTournaments`, `name`, `active`) VALUES (3, '3 vs 3', 1);
INSERT INTO `mytournament`.`FormatOfTournaments` (`idFormatTournaments`, `name`, `active`) VALUES (4, '4 vs 4', 1);
INSERT INTO `mytournament`.`FormatOfTournaments` (`idFormatTournaments`, `name`, `active`) VALUES (5, '5 vs 5', 1);
