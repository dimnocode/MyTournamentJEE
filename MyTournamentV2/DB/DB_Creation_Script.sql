...
-- -----------------------------------------------------
-- Table `mytournament`.`GameAccountPlatforms`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mytournament`.`GameAccountPlatforms` ;

CREATE TABLE IF NOT EXISTS `mytournament`.`GameAccountPlatforms` (
  `idGameAccountPlatforms` INT NOT NULL,
  `nom` VARCHAR(45) NOT NULL,
  `active` TINYINT(1) NULL,
  PRIMARY KEY (`idGameAccountPlatforms`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mytournament`.`GameAccounts` (
  ...
  INDEX `fk_GameAccounts_TypeGameAccounts1_idx` (`idGameAccountPlatforms` ASC),
  ...
  CONSTRAINT `fk_GameAccounts_TypeGameAccounts1`
    FOREIGN KEY (`idGameAccountPlatforms`)
    REFERENCES `mytournament`.`GameAccountPlatforms` (`idGameAccountPlatforms`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
